export function Contact(params) {
    return (
        <section className='mb-8'>
            ...
            <p className="font-light text-center mx-auto text-balance text-sm lg:text-lg lg:w-3/4">I&apos;m currently looking for new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I&apos;ll try my best to get back to you!</p>
            <a href="mailto:sunart.devux@gmail.com" className='flex justify-center mt-4'>
